...
int minDistance(string word1, string word2) {
    ...
    return minDistanceUsingMemoHelper(word1, word2, word1.length(),
                                      word2.length());
}
...
/*
anonys6: solve the problem solved in memo usign dp, problem is already solve
using memo, give solution in dp. Approach for dp is given for another problem,
use that to implement dp.
